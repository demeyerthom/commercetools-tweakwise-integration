...
import (
	...
	swaggerserversrv "github.com/demeyerthom/commercetools-tweakwise-integration/src/server"
...
func main() {
	...
	api := operations.NewCommercetoolsTweakwiseIntegrationManagerAPI(swaggerSpec)
